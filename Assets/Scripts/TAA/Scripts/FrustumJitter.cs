...
public class FrustumJitter : MonoBehaviour
{
    ...
    public void PreCull( ScriptableRenderContext context )
    {
        // update motion dir
        {
...
#endif
        {
            ...
            else
            {
                ...
                Matrix4x4 customProjectionMatrix = _camera.GetProjectionMatrix(sample.x, sample.y);
    ...
    // void SetProjectionMatrix(ScriptableRenderContext context)
    // {
    //     Camera camera = _camera.Clone();
